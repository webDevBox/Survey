                            ...
                            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                ...
                                <tr>
                                    <td style="padding: 0px 0 10px 0; color: #153643;   font-size: 14px; line-height: 20px;">
                                        @if(!is_null($company->reason))
                                            {{ $company->reason }}
                                        @else
                                            Your account is @if($company->status == 1) Enabled, @else Disabled, @endif You can. <a href="{{ route('company-login') }}">Login</a>
                                        @endif
                                    </td>
                                </tr>
								<tr>
                            ...
                            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                <tr>
                                    <td style="color: #ffffff;   font-size: 12px; margin-left: 17px; " width="50%">
                                        Copyright © 2020 {{ config('app.name') }}. All rights reserved.<br/>
                                    </td>
