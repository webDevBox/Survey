...
@endsection
@section('breadcrumb')
    <li class="breadcrumb-item active"> <a href="{{ route('adminDashboard') }}"> Dashboard </a> > <a href="{{ route('admin.reports') }}">Reports</a> > Details </li>
@endsection
@section('content')
<div class="content">
            ...
            <div class="col-12">
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        ...
                        <input type="hidden" name="locationId" value={{$reportData['locationId']}}" id="locationId">
...
<script src="{{ asset('assets/js/qbReportByLocation.js') }}"></script>
<!-- Google Charts js -->
