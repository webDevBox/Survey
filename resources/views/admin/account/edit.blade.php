...
@section('breadcrumb')
    <li class="breadcrumb-item active"> <a href="{{ route('adminDashboard') }}"> Dashboard </a> > Edit Profile</li>
@endsection
    ...
    <div class="container-fluid">
      <div class="row">
        <div class="col-12">
          ...
          <div class="card-box">
          <form action="{{ route('adminAccountUpdate') }}" method="post" enctype="multipart/form-data">
            {{csrf_field()}}

            <div class="form-row">                                   
              <div class="form-group col-md-12">
                  <div id="profile-container">
                      <img id="profileImage" src="{{ asset('images/'.$admin->logo) }}" />
                   </div>
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-6">
                      ...
                      <input  type="text" name="name" class="form-control {{ $errors->has('name') ? ' is-invalid' : '' }}" value="{{ $admin->name }}" id="">
                      @if ($errors->has('name'))
                      <span class="invalid-feedback" role="alert">
